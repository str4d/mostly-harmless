...
pub(super) fn label_events_for<L: FromStr>(
    timeline_items: issues_with_labels_query::IssuesWithLabelsQueryRepositoryIssuesEdgesNodeTimelineItems,
) -> Vec<LabelEvent<L>> {
    use self::issues_with_labels_query::IssuesWithLabelsQueryRepositoryIssuesEdgesNodeTimelineItemsEdgesNode::{
        LabeledEvent,
        UnlabeledEvent,
    };
