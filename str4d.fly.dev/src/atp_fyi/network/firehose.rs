...
macro_rules! record_metrics {
    ($metrics:expr, $metric:expr, $count:expr) => (record_metrics!(
        ...
        ("atproto_firehose_ops_blatball" => ops_blatball),
        ("atproto_firehose_ops_blento" => ops_blento),
        ...
        ("atproto_firehose_ops_deckbelcher" => ops_deckbelcher),
        ...
        ("atproto_firehose_ops_margin" => ops_margin),
        ("atproto_firehose_ops_picosky" => ops_picosky),
        ("atproto_firehose_ops_pinksky" => ops_pinksky),
        ("atproto_firehose_ops_podping" => ops_podping),
        ("atproto_firehose_ops_popfeed" => ops_popfeed),
        ...
        ("atproto_firehose_ops_semble" => ops_semble),
        ("atproto_firehose_ops_shadowsky" => ops_shadowsky),
        ("atproto_firehose_ops_sigintteam" => ops_sigintteam),
        ...
        ("atproto_firehose_ops_standardsite" => ops_standardsite),
...
pub(crate) struct FirehoseRate {
    ...
    pub(crate) ops_blatball: f64,
    pub(crate) ops_blento: f64,
    ...
    pub(crate) ops_margin: f64,
    pub(crate) ops_picosky: f64,
    pub(crate) ops_pinksky: f64,
    pub(crate) ops_podping: f64,
    pub(crate) ops_popfeed: f64,
    ...
    pub(crate) ops_semble: f64,
    pub(crate) ops_shadowsky: f64,
    pub(crate) ops_sigintteam: f64,
    ...
    pub(crate) ops_standardsite: f64,
...
impl FirehoseRate {
    pub(crate) fn groups(&self) -> Vec<FirehoseGroup> {
        ...
        let mut groups = vec![
            ...
            g("Blatball", "https://blatball.com/", self.ops_blatball),
            g("blento", "https://blento.app/", self.ops_blento),
            ...
            g("Margin", "https://margin.at/", self.ops_margin),
            g("Picosky", "https://psky.social/", self.ops_picosky),
            g("Pinksky", "https://pinksky.app/", self.ops_pinksky),
            g("Podping", "", self.ops_podping),
            g("Popfeed", "https://popfeed.social/", self.ops_popfeed),
            ...
            g("Semble", "https://semble.so/", self.ops_semble),
            g("ShadowSky", "https://shadowsky.io/", self.ops_shadowsky),
            g(
                "SIGINT Team",
                "https://bsky.app/profile/sigint.team",
                self.ops_sigintteam,
            ),
